 ...
 * Api
 * Maryland Representatives Civic App API
 ...
 */
export const getGetStateMemberVotesUrl = (memberId: string) => {
  return `/api/state/members/${memberId}/votes`;
};
...
export const getStateMemberVotes = async (
  ...
  return customFetch<StateVotesListResponse>(
    getGetStateMemberVotesUrl(memberId),
    {
      ...options,
      method: "GET",
    },
...
export const getGetStateMemberVotesQueryKey = (memberId: string) => {
  return [`/api/state/members/${memberId}/votes`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetStateMemberVotesQueryKey(memberId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getStateMemberVotes>>
  > = ({ signal }) =>
    getStateMemberVotes(memberId, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getGetStateMemberVotesQueryOptions(memberId, options);
...
/**
 * @summary Get bills being considered in the Maryland legislature
 */
